...
use backend\widgets\TagsInput;
use yii\helpers\Html;
use yii\helpers\Url;
use yii\widgets\ActiveForm;
use backend\widgets\Redactor;
use backend\widgets\SeoForm;
...
<?php if($this->context->module->settings['enableThumb']) : ?>
    <?php if($model->image) : ?>
        ...
        <a href="<?= Url::to(['/admin/'.$module.'/a/clear-image', 'id' => $model->news_id]) ?>" class="text-danger confirm-delete" title="<?= Yii::t('backend', 'Clear image')?>"><?= Yii::t('backend', 'Clear image')?></a>
    <?php endif; ?>
