...
class SettingsController extends \backend\components\Controller
{
    ...
    public function actionIndex()
    {
        $data = new ActiveDataProvider([
            'query' => Setting::find()->where([
                '>=',
                'visibility',
                IS_ROOT ? Setting::VISIBLE_ROOT : Setting::VISIBLE_ALL
            ])
        ]);
    ...
    public function actionCreate()
    {
        ...
        if ($model->load(Yii::$app->request->post())) {
            if (Yii::$app->request->isAjax) {
                ...
                if ($model->save()) {
                    $this->flash('success', Yii::t('backend', 'Setting created'));
    ...
    public function actionEdit($id)
    {
        ...
        if ($model->load(Yii::$app->request->post())) {
            if (Yii::$app->request->isAjax) {
                ...
                if ($model->save()) {
                    $this->flash('success', Yii::t('backend', 'Setting updated'));
                } else {
    ...
    public function actionDelete($id)
    {
        ...
        return $this->formatResponse(Yii::t('backend', 'Setting deleted'));
    }
}