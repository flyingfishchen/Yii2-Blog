...
class Controller extends \yii\web\Controller
{
    ...
    public function beforeAction($action)
    {
        ...
        if (Yii::$app->user->isGuest) {
            ...
            if ($this->id != Yii::$app->defaultRoute && ! Helper::checkRoute($this->getRoute())) {
     ...
     * 
     * @param mixed $url
     *            if not set, returnUrl will be current page
     */
     ...
     * 
     * @param mixed $defaultUrl
     *            if return url not found in sessions
     * @return mixed
     */
