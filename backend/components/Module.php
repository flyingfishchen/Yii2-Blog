...
/**
 * Base module class.
 * Inherit from this if you are creating your own modules manually
 * 
...
class Module extends \yii\base\Module
{
    ...
    public static function registerTranslations($moduleName)
    {
        ...
        if ($moduleClassFile) {
            Yii::$app->i18n->translations['backend/' . $moduleName . '*'] = [
                'class' => 'yii\i18n\PhpMessageSource',
                'sourceLanguage' => 'en-US',
                'basePath' => dirname($moduleClassFile) . DIRECTORY_SEPARATOR . 'messages',
                'fileMap' => [
                    'backend/' . $moduleName => 'admin.php',
                    'backend/' . $moduleName . '/api' => 'api.php'
                ]
            ];
        }
    }
