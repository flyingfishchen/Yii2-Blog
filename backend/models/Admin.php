...
use Yii;
use backend\helpers\Assignment;

class Admin extends \backend\components\ActiveRecord implements \yii\web\IdentityInterface
{
    static $rootUser = [
        'admin_id' => 0,
        'username' => 'root',
    ...
    {
        return isset(Assignment::getItems($this->id)['assigned']['root']);
    }
}
