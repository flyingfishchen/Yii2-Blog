...
class Upload
{
    ...
    {
        $uploadPath = Yii::getAlias('@uploads')./*DIRECTORY_SEPARATOR.self::$UPLOADS_DIR.*/($dir ? DIRECTORY_SEPARATOR.$dir : '');
    ...
    {
        return Yii::$app->params['attachUrl'] . str_replace('\\', '/', str_replace(Yii::getAlias('@uploads'), '', $fileName));
    }
